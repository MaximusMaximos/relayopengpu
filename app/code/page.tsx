...
>
  <div className="w-full max-w-[1800px] mx-auto px-6">
    ...
    <p className="
      ...
      drop-shadow-md
    ">
      Route workloads to any GPU worldwide, instantly and automatically at up to 80% less than traditional cloud cost. Access high-performance compute without proprietary vendor lock-in.
    </p>
