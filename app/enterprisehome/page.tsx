...
export default function EnterprisePage() {
  return (
    <main className="relative w-full min-h-screen bg-[#040814] text-white">
      {/* FIXED HEADER (SAME AS MAIN SITE STYLE) */}
      <header className="fixed top-0 left-0 w-full z-[999]">
        <nav className="w-full flex items-center justify-between px-10 py-4 bg-[#00040F]/70 backdrop-blur-xl border-b border-[#00C8FF]">
          ...
          <div className="flex items-center gap-8 text-base md:text-lg text-gray-200 font-medium">
            ...
            <a href="/" className="px-10 py-3.5 rounded-xl font-semibold text-base md:text-lg border border-[#00E9FF] text-[#00E9FF] transition-all duration-300 hover:bg-[#00B5E2] hover:text-[#001019]">
              Back to main site
            </a>
          </div>
        </nav>
      ...
      <section className="w-full min-h-screen bg-[#040814] pt-40 pb-24 px-6 flex items-center">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[45%_55%] gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-6">
            <p className="text-xs font-semibold tracking-[0.2em] text-[#00E9FF] uppercase">
              Enterprise Pilot
            </p>
            ...
            <p className="text-base md:text-lg text-gray-300 leading-relaxed">
              ...
              <span className="font-semibold text-[#00E9FF]">
          ...
          <div className="w-full">
            <div className="bg-white rounded-2xl shadow-[0_18px_50px_rgba(0,0,0,0.45)] border border-slate-200 p-6 md:p-8">
              <div className="flex flex-col items-center mb-6">
                <img
                  src="https://digitalgramophone.com/ogpu/Images/OGPU-LOGO-Main-black.png"
                  alt="OGPU Logo"
