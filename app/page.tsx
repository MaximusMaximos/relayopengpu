  ...
  return (
    <main className="relative w-full bg-[#040814] text-white">
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        {/* All hero content MUST stay inside this wrapper */}
      ...
      {/* ========================================= */}
      {/* NEXT SECTION TO ENABLE SCROLL             */}
      {/* ========================================= */}
      <section className="w-full min-h-screen bg-black flex items-center justify-center text-white text-4xl">
